...
try{
  ...
  add(new THREE.CylinderGeometry(1,1,.16,64),mats.glass,[S(-1.55,0,0,Math.PI/2,0,0,1.45,1,1),S(0,0,0,Math.PI/2,0,0,.02,.02,.02),S(-1.2,.35,.2,Math.PI/2,.2,0,1.15,1,1),S(0,0,0,Math.PI/2,0,0,1.5,1,1)]);
  add(new THREE.CylinderGeometry(1,1,.16,64),mats.glass,[S(1.55,0,0,Math.PI/2,0,0,1.45,1,1),S(0,0,0,Math.PI/2,0,0,.02,.02,.02),S(.95,-.2,-.3,Math.PI/2,-.28,.08,.72,.72,1),S(0,0,.06,Math.PI/2,0,0,.78,.78,1)]);
  ...
  add(new THREE.TorusGeometry(1.48,.105,12,72),mats.navy,[S(-1.55,0,.04,0,0,0,1,.78,1),S(0,0,0,0,0,0,.02,.02,.02),S(-1.2,.35,.28,.12,.2,0,.82,.68,1),S(0,0,.1,0,0,0,1.05,.66,1)]);
  add(new THREE.TorusGeometry(1.48,.105,12,72),mats.navy,[S(1.55,0,.04,0,0,0,1,.78,1),S(0,0,0,0,0,0,.02,.02,.02),S(.95,-.2,-.2,-.12,-.24,.08,.55,.5,1),S(0,0,.11,0,0,0,.56,.56,1)]);
  add(new THREE.TorusGeometry(3.45,.19,14,96,Math.PI),mats.cyan,[S(0,0,0,0,0,0,.02,.02,.02),S(0,.12,-.7,0,0,0,1,.78,1),S(0,-1.1,.15,Math.PI/2,0,0,.78,.82,1),S(0,.38,.08,0,0,.04,1,.62,1)]);
  add(new THREE.TorusGeometry(3.45,.12,12,96,Math.PI),mats.navy,[S(0,0,0,0,0,0,.02,.02,.02),S(0,-.12,-.65,0,Math.PI,0,1,.72,1),S(0,1.1,-.12,Math.PI/2,0,0,.78,.82,1),S(0,-.38,.06,0,Math.PI,.04,1,.62,1)]);
  ...
  const railStates=[
    [S(0,0,.12,0,0,0,1.15,.12,.12),S(0,-.02,.32,0,0,0,2.3,.08,.08),S(-.2,-1.35,0,0,0,0,3.4,.1,.12),S(-1.8,.45,.02,0,0,-.12,1.7,.12,.12)],
    [S(-3.45,.15,-.4,0,-.35,.08,2.7,.13,.15),S(-2.72,0,-.28,0,0,Math.PI/2,1.2,.1,.1),S(-2.8,-.55,.1,0,0,Math.PI/2,1.3,.1,.1),S(-1.6,-.55,.02,0,0,-.2,1.4,.1,.1)],
    [S(3.45,.15,-.4,0,.35,-.08,2.7,.13,.15),S(2.72,0,-.28,0,0,Math.PI/2,1.2,.1,.1),S(2.7,-.7,.15,0,0,Math.PI/2,1.2,.1,.1),S(1.65,-.5,.02,0,0,.2,1.4,.1,.1)],
    [S(-4.15,-.2,-.8,0,-.45,.02,2.5,.12,.14),S(-2.65,.58,-.52,0,0,0,1.25,.08,.08),S(-2.2,.1,-.45,0,.35,.1,1.7,.1,.1),S(1.9,.5,.03,0,0,.15,1.45,.1,.1)],
    [S(4.15,-.2,-.8,0,.45,-.02,2.5,.12,.14),S(2.65,.58,-.52,0,0,0,1.25,.08,.08),S(2.15,.25,-.5,0,-.38,-.1,1.7,.1,.1),S(-1.8,.55,.03,0,0,-.15,1.45,.1,.1)]
  ];
  ...
  for(let i=0;i<7;i++){
    ...
    add(orb,i===0?mats.white:mats.cyan,[S(0,0,0,0,0,0,.02,.02,.02),S(0,0,0,0,0,0,.02,.02,.02),S(Math.cos(a)*3.15,-.2+Math.sin(a)*1.35,.15+Math.cos(a)*.5),S(i===0?-.45:Math.cos(a)*1.15,i===0?.35:Math.sin(a)*.85,.28,0,0,0,i===0?.65:.2,i===0?.65:.2,i===0?.65:.2)]);
  }

  // The final 3D identity adopts the flat mark's left-cyan / right-amber grammar.
  add(box,mats.cyan,[S(-2.6,-.3,.1,0,0,0,.05,.05,.05),S(-1.95,.35,.35,0,0,-.08,.58,.2,.12),S(-2.4,-.55,.1,0,.15,.06,.72,.25,.16),S(-1.55,-.12,.34,0,0,-.08,.82,.22,.15)]);
  add(box,mats.cyan,[S(-2.3,-.7,.1,0,0,0,.05,.05,.05),S(-1.82,-.18,.35,0,0,.08,.5,.24,.12),S(-1.8,-1.05,.2,0,.12,-.04,.64,.28,.15),S(-1.42,-.5,.32,0,0,.08,.68,.25,.15)]);
